...
const menuGroups = [
  ...
  },
  {
    title: "MANAJEMEN",
    links: [
      { name: "Produk", path: "/produk", icon: Package, roles: ["admin", "guest"] },
      { name: "Stok", path: "/stok", icon: Archive, roles: ["admin", "guest"] },
      { name: "Supplier", path: "/supplier", icon: Truck, roles: ["admin", "guest"] },
    ],
  },
  {
    title: "LAPORAN",
    links: [
      ...
      { name: "Kasbon", path: "/kasbon", icon: BookUser, roles: ["admin", "kasbon"] },
    ],
  },
];
