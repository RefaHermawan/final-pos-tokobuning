...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'rest_framework.authtoken', # Dibutuhkan oleh dj-rest-auth
    'dj_rest_auth',
    'corsheaders',
...
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',  # Ini yang paling penting
    'content-type',
    'dnt',
    'origin',
    'user-agent',
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        # Aturan global: Semua view wajib otentikasi
        'rest_framework.permissions.IsAuthenticated',
    ),
    'DEFAULT_PAGINATION_CLASS': 'pos_project.pagination.StandardResultsSetPagination',
}
